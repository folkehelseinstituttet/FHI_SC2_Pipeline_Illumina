gisaid_md <- read_tsv(file = "/home/jonr/Downloads/gisaid_hcov-19_2022_01_24_09.tsv")
...
write_csv(to_BN, 
          file = "/mnt/N/Virologi/NGS/1-NGS-Analyser/1-Rutine/2-Resultater/SARS-CoV-2/4-GISAIDsubmisjon/2022.01.24_MIK_batch_import.csv",
          quote = "all")
...
write_csv(to_BN_rest, 
          file = "/mnt/N/Virologi/NGS/1-NGS-Analyser/1-Rutine/2-Resultater/SARS-CoV-2/4-GISAIDsubmisjon/2022.01.24_BN_batch_import.csv",
          quote = "all")
